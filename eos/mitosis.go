...
// Mitosis is an algorithm running periodically to check,
// if the load is big enough to trigger the scale out logic.
...
// Assume we handle sessions that require 10 MBps sustained lines.
...
// 1000 MBps / 10 MBps * 50% = 50 concurrent sessions.
//
